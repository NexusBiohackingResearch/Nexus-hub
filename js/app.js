...
const translations = {
  fr: {
    navDomains:"Domaines",navCatalogue:"Catalogue",navCalc:"Calculateur",navPay:"Comment payer",navQuality:"Qualité",navDelivery:"Livraison",navContact:"Contact",order:"Commander",
    heroEyebrow:"PEPTIDES DE RECHERCHE HAUTE PURETÉ",heroTitle:"Une nouvelle ère<br>de la recherche.<br><span>Pureté 99%.</span>",
    heroLead:"Pureté 99%, paiement sécurisé en cryptomonnaie et livraison rapide en France et en Europe.",
    ...
    articlesEyebrow:"LE LABORATOIRE",articlesTitle:"Recherche & <span>articles</span>",articlesLead:"Nos publications sur les peptides de recherche et leurs axes d'étude, mises à jour régulièrement.",articlesRead:"Lire",articlesEmpty:"Articles à venir.",articlesAll:"Tous les articles →",bestEyebrow:"PRODUITS PHARES",bestTitle:"Nos <span>best-sellers</span> du moment",bestLead:"Les références les plus demandées par nos chercheurs en ce moment.",announceTag:"Annonce importante",
  ...
  en: {
    ...
    articlesEyebrow:"THE LAB",articlesTitle:"Research & <span>articles</span>",articlesLead:"Our publications on research peptides and their areas of study, updated regularly.",articlesRead:"Read",articlesEmpty:"Articles coming soon.",articlesAll:"All articles →",bestEyebrow:"BEST SELLERS",bestTitle:"Our <span>top picks</span> right now",bestLead:"The references most requested by our researchers right now.",announceTag:"Important notice",
    ...
    orderProduct:"Order this compound",continueBrowsing:"Continue exploring",footerAbout:"Premium research peptides intended exclusively for laboratory and in vitro study. Built around purity, documentation and traceability.",footerCatalogueTitle:"CATALOGUE",footerAllProducts:"All compounds",footerDomains:"Research fields",footerQuality:"Quality",footerSupportTitle:"SUPPORT",footerTelegram:"Contact",footerShipping:"Shipping",footerLegalTitle:"LEGAL",footerCgvSoon:"Terms coming soon",footerPrivacySoon:"Privacy coming soon",footerResearchPolicy:"Research use policy",documentLoading:"Loading product information…",documentUnavailable:"Detailed information coming soon.",researchFields:"Research fields",technicalData:"Technical data",coaTitle:"Certificate of Analysis",viewCoa:"View COA",footerWarningTitle:"WARNING:",footerWarningText:"All products shown on this website are intended exclusively for research and laboratory use. They are not intended for human or animal consumption, diagnosis or therapeutic use. Nothing on this website constitutes a medical claim."
  }
};
